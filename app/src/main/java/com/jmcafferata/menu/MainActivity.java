...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        item1.setPrecio(R.integer._1Precio);
        ...
        item2.setPrecio(R.integer._2Precio);
        ...
        item3.setPrecio(R.integer._3Precio);
        ...
        item4.setPrecio(R.integer._4Precio);
        ...
        item5.setPrecio(R.integer._5Precio);
        ...
        item6.setPrecio(R.integer._6Precio);
